...
const char * const BITCOIN_CONF_FILENAME = "nbscoin.conf";
const char * const BITCOIN_PID_FILENAME = "nbscoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Nbscoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Nbscoin";
#else
    // Unix
    return pathRet / ".nbscoin";
#endif
#endif
}
