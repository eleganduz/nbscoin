...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s nbscoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  nbscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nbscoin transaction") + "\n" +
              "  nbscoin-tx [options] -create [commands]   " + _("Create hex-encoded nbscoin transaction") + "\n" +
              "\n";
