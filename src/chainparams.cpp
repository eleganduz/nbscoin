...
{
    const char* pszTimestamp = "NBSCOIN UZ IT-TECHNOLOGY Kompaniya tomonidan ishlab chiqilgan 2022/11/01";
    const CScript genesisOutputScript = CScript() << ParseHex("160184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1667580180, 2000370603, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x54cadd86e5f0891fb384918d679422dae692c8b2b7aa03d03a1fefd554f9a03e"));
        assert(genesis.hashMerkleRoot == uint256S("0xc07f03c44436bce29039f016b375e6293a810344b625a4c238c7ae56d2dbd460"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("172.104.18.172", "172.104.18.172", true));
        vSeeds.push_back(CDNSSeedData("170.187.185.240", "170.187.185.240", true));
        //vSeeds.push_back(CDNSSeedData("nbscointools.com", "dnsseed.nbscointools.com"));
        //vSeeds.push_back(CDNSSeedData("nbscoinpool.org", "dnsseed.nbscoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x54cadd86e5f0891fb384918d679422dae692c8b2b7aa03d03a1fefd554f9a03e"))
        ...
        chainTxData = ChainTxData{
            ...
            1667580180, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1667580180, 109633, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0fd96545d0e5dcc9e2155a5120b6a24530ed42b667d5bf0c11e066b39b7a9530"));
        assert(genesis.hashMerkleRoot == uint256S("0xc07f03c44436bce29039f016b375e6293a810344b625a4c238c7ae56d2dbd460"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("172.104.18.172", "172.104.18.172"));
        vSeeds.push_back(CDNSSeedData("170.187.185.240", "170.187.185.240", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x0fd96545d0e5dcc9e2155a5120b6a24530ed42b667d5bf0c11e066b39b7a9530")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1667580180, 1, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x8b1a51bb92dc3c14296cdb27c63fd30783115c685127f313bd9444f905eefa73"));
        assert(genesis.hashMerkleRoot == uint256S("0xc07f03c44436bce29039f016b375e6293a810344b625a4c238c7ae56d2dbd460"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x8b1a51bb92dc3c14296cdb27c63fd30783115c685127f313bd9444f905eefa73"))
        };
